...
setwd("/Applications/Working_Directory/uni-capstone-project-dengue/")

data <- read.csv("/Applications/Working_Directory/uni-capstone-project-dengue/Data/data-regression/final_table.csv", fileEncoding = "UTF-8-BOM")
...
```{r plot_precipitation, echo=TRUE}
plot_precipitation
plot_temperature
